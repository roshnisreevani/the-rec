...
export type ReportReasonOption = { value: ReportReason; label: string };

// Feed's default reasons (posts/comments) — Connections passes its own list
// (harassment / fake profile / inappropriate / other, no "spam") via the
// reportReasons prop below.
...
// The "..." action sheet used across Feed (posts/comments) and Connections
